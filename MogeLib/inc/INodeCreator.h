...
namespace Moge
{
    ...
    public:
        ...
        virtual std::shared_ptr<Node> createFromImage( const CUL::FS::Path& filePath, const Math::IPosition<int>& position = Math::IPositionAdapter<int>( 0, 0, 0 ), const MyString& name = MyString( "" ) ) = 0;
